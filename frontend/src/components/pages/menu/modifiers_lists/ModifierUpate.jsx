...
class ModifierUpate extends Component {
    ...
    componentDidMount() {
        axios.get(`${modifierURL}${this.props.match.params.id}`)
        .then((res) => {
    ...
    submitHandler = e => {
        ...
        this.props.modifierUpdateAction(this.props.match.params.id, {name, display_name, max, min, is_multiple});
    }
...
export default connect(mapStateToProps, {modifierUpdateAction}) (ModifierUpate)
